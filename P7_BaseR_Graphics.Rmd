...
Base R graphics are powerful, fast, and require no additional packages [@idiotsGuideGraphicsBaseR]. While packages like ggplot2 offer advanced features [@r-graphicsChang], base R graphics provide an excellent starting point and remain widely used for quick exploratory analysis and publication-quality figures.
